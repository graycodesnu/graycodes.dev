       ...
       absolute inset-y-0 right-0 w-fit h-fit"
        ...
        >
          ...
          <motion.svg
            ...
            viewBox="0 0 24 24"
            stroke-width=".5"
            className="z-10 -mb-4 2xl:invisible aspect-auto object-contain rounded-lg xl:aspect-auto lg:h-64 lg:w-full 2xl:object-contain"
            variants={draw}
          >
            <motion.path
          ...
          <motion.svg
            ...
            fill="#0e0e0e"
            stroke-width=".5"
            className="z-0 2xl:invisible aspect-auto object-contain rounded-lg xl:aspect-auto lg:h-full lg:w-full 2xl:object-contain"
            variants={draw}
          >
            <motion.path
